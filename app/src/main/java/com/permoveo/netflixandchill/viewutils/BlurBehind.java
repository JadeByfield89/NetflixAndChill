...
/**
 * Created by byfieldj on 4/29/16.
 */
...
import com.permoveo.netflixandchill.interfaces.OnBlurCompleteListener;
...
public class BlurBehind {
    ...
    private class CacheBlurBehindAndExecuteTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            Bitmap blurredBitmap = BlurBuilder.blur(activity, image, CONSTANT_BLUR_RADIUS);
